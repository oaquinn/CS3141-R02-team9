...
<body class="bg-dark">
    <nav class="navbar navbar-dark bg-primary navbar-expand sticky-top">
        <a class="navbar-brand " href="../php/MainPage.php">Langlearn</a> 
    ...
    <main class="">
        <header class="text-center  pb-5 bg-light">
            <div class="container">
                ...
                <p class="display-4 text-dark">Anki Decks</p>
            </div>
			 <div class="">
          
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                   3/16/2022 - https://ankiweb.net/shared/info/276380336
                </li>
				<b2> <a class="button button2" id="Uploadfile" href="#">Upload a New Deck</a> </b2>
            </ul>
        </div>
        </header>
